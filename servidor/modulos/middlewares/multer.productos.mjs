...
const carpetaDestino = path.join(__dirname, '..', '..', 'public', 'img', 'archivos');
...
const imageHandler = subida.single('imagen');

export const verificacionImagenProducto = (req, res, next) => {
